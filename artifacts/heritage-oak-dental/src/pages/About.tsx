      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Committed to providing our Rocklin community with advanced, comfortable, and personalized dental care.
          </p>
        </div>
        ...
        <section id="office" className="scroll-mt-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Our Modern Office</h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                We've designed our Rocklin practice with your comfort in mind. From our welcoming reception area to our advanced treatment rooms equipped with the latest dental technology, every detail is focused on providing a positive experience.
              </p>
