...
const LOCAL_BUSINESS_SCHEMA = {
  ...
  image: "https://www.heritageoakdental.com/opengraph.jpg",
  ...
  sameAs: [
    "https://www.facebook.com/heritageoakdental",
    "https://www.google.com/maps/place/Heritage+Oak+Dental/",
  ],
};
...
export function Home() {
  return (
    <>
      <SEOHead
        title="Dentist in Rocklin, CA | Heritage Oak Dental"
        description="Heritage Oak Dental is Rocklin's top-rated dental office offering general, cosmetic, implant, orthodontic & pediatric dentistry. Serving Rocklin, Roseville, Granite Bay, Loomis & Sacramento. Call (916) 626-4050."
        keywords="dentist Rocklin CA, dental office Rocklin, family dentist Rocklin, Heritage Oak Dental, teeth cleaning Rocklin, dental implants Rocklin, cosmetic dentistry Rocklin"
        canonicalPath="/"
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  ...
                  the industry, such as intraoral cameras, digital x-rays, oral
                  sedation, dental lasers, CAD CAM, implants, white fillings, 3D
                  imaging, invisible ceramic braces, clear braces, and Invisalign
                  to ensure that you receive the most effective and efficient care
                  possible.
                </p>
              ...
              <div className="relative lg:ml-auto w-full max-w-lg">
                ...
                <img
                  ...
                  alt="Modern Heritage Oak Dental waiting room in Rocklin, CA"
                  width={640}
                  height={480}
                  loading="eager"
                  fetchPriority="high"
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {SERVICES.map((service) => (
                <Link
                  ...
                  aria-label={`Learn more about ${service.title} at Heritage Oak Dental`}
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-lg text-muted-foreground text-balance">
                ...
                families throughout Rocklin, Roseville, Granite Bay, and Loomis
                trust us for their dental care.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto relative rounded-[2rem] overflow-hidden shadow-2xl border-8 border-white bg-black aspect-video">
              <iframe
                ...
                title="Heritage Oak Dental Office Tour — Rocklin, CA"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
                Dr. Shane Douglas and Dr. Ben Kloss bring decades of combined experience to patients throughout Rocklin, Roseville, Granite Bay, and Sacramento.
              </p>
            </div>
                ...
                <div key={member.id} className="text-center group">
                  <div className="relative w-64 h-64 mx-auto mb-6 rounded-full overflow-hidden border-4 border-muted group-hover:border-primary/30 transition-colors">
                    <img
                      ...
                      alt={`${member.name} — Dentist in Rocklin, CA at Heritage Oak Dental`}
                      width={256}
                      height={256}
                      loading="lazy"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-blue-200 max-w-2xl mx-auto text-lg">
                Heritage Oak Dental is conveniently located in Rocklin, CA and
                welcomes patients from across the region including:
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-10">
              {SERVICE_CITIES.map((city) => (
                ...
                >
                  <CheckCircle className="w-4 h-4 text-[#1B89C5] flex-shrink-0" />
            ...
            <p className="text-center text-blue-300 text-sm">
              Located at <strong className="text-white">3700 Atherton Rd, Rocklin, CA 95765</strong>.
              Easy access from I-80 and Highway 65 — serving all of Placer County and the Sacramento metro area.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  ...
                  from Roseville, Granite Bay, Loomis, Lincoln, Folsom, and the
                  greater Sacramento area. We look forward to welcoming you!
                </p>
                ...
                <div className="rounded-2xl overflow-hidden shadow-lg border-4 border-white aspect-video bg-gray-200 relative">
                  <iframe
                    ...
                    title="Heritage Oak Dental map — 3700 Atherton Rd, Rocklin, CA"
                    className="absolute inset-0 w-full h-full"
                    style={{ border: 0 }}
                    allowFullScreen
                    loading="lazy"
